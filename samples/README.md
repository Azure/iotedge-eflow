...
| [Inventory Management for IoT Connected Coolers Solution Accelerator](https://github.com/microsoft/Inventory-Management-for-IoT-Connected-Coolers-Solution-Accelerator) | This solution accelerator shows you how to develop an inventory management solution, IoT and AI powered solution that tracks inventory at remote locations, uploads this data to Azure, and applies machine learning based forecasting models to predict restocking needs. This data on future needs can be use in a variety of ways, not the least of which is scheduling delivery trucks (or other resources) more efficiently. |   
